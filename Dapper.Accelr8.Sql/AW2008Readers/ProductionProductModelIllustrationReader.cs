...
{
    public class ProductionProductModelIllustrationReader : EntityReader<int, ProductionProductModelIllustration>
    {
		...
		/// </summary>
		/// <param name="results">IEntityReader<int, ProductionProductModelIllustration></param>
		/// <param name="id">int</param>
        public override IEntityReader<int, ProductionProductModelIllustration> WithAllChildrenForId(int id)
        {
