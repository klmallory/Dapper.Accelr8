...
{
    public class PersonBusinessEntityContactReader : EntityReader<CompoundKey, PersonBusinessEntityContact>
    {
        ...
        public override PersonBusinessEntityContact LoadEntity(dynamic row)
        {
			...
			domain.BusinessEntityID = GetRowData<int>(dataRow, "BusinessEntityID"); 
      		...
      		domain.ContactTypeID = GetRowData<int>(dataRow, "ContactTypeID"); 
      		domain.rowguid = GetRowData<Guid>(dataRow, "rowguid"); 
      		domain.ModifiedDate = GetRowData<DateTime>(dataRow, "ModifiedDate"); 
      				domain.Id = PersonBusinessEntityContact.GetCompoundKeyFor(domain); 
		...
		/// </summary>
		/// <param name="results">IEntityReader<CompoundKey, PersonBusinessEntityContact></param>
		/// <param name="id">CompoundKey</param>
        public override IEntityReader<CompoundKey, PersonBusinessEntityContact> WithAllChildrenForExisting(PersonBusinessEntityContact existing)
        {
