...
{
    public class ProductionProductInventoryReader : EntityReader<int, ProductionProductInventory>
    {
		...
		/// </summary>
		/// <param name="results">IEntityReader<int, ProductionProductInventory></param>
		/// <param name="id">int</param>
        public override IEntityReader<int, ProductionProductInventory> WithAllChildrenForId(int id)
        {
