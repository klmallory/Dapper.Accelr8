...
{
	public class Workspace : Dapper.Accelr8.Repo.Domain.BaseEntity<int>, IEntity, IHaveId<int>
	{	
		public Workspace()
		{
			IsDirty = false;
		...
		protected IList<DefaultValue> _defaultValues;
		...
		protected IList<WorkspaceName> _workspaceNames;
		public IList<WorkspaceName> WorkspaceNames 
		{ 
			get { return _workspaceNames; }
			set 
			{ 
		...
		protected IList<BiographicGroup> _biographicGroups;
		public IList<BiographicGroup> BiographicGroups 
		{ 
