...
{
	public class Submission : Dapper.Accelr8.Repo.Domain.BaseEntity<int>
	{	
		public Submission()
		{
			IsDirty = false;
		...
		protected SubmissionStatusHistory _submissionStatusHistories;
		public SubmissionStatusHistory SubmissionStatusHistories 
		{ 
		...
		protected MatchRequest _matchRequests;
		public MatchRequest MatchRequests 
		{ 
