...
{
	public class Transaction : Dapper.Accelr8.Repo.Domain.BaseEntity<int>
	{	
		public Transaction()
		{
			IsDirty = false;
		...
		protected EnrollmentMnemonicValue _enrollmentMnemonicValues;
		public EnrollmentMnemonicValue EnrollmentMnemonicValues 
		{ 
		...
		protected TransactionFilePath _transactionFilePaths;
		public TransactionFilePath TransactionFilePaths 
		{ 
		...
		protected Biometric _biometrics;
		public Biometric Biometrics 
		{ 
		...
		protected TransactionStatusHistory _transactionStatusHistories;
		public TransactionStatusHistory TransactionStatusHistories 
		{ 
