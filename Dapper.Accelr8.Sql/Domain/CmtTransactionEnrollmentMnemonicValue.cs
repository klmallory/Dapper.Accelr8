...
{
	public class CmtTransactionEnrollmentMnemonicValue : Dapper.Accelr8.Repo.Domain.BaseEntity<int>, IEntity, IHaveId<int>
	{	
		...
		protected string _submissionSpcStatus;
		public string SubmissionSpcStatus 
		{ 
			get { return _submissionSpcStatus; }
			set 
			{ 
				_submissionSpcStatus = value;  
				IsDirty = true;
			}
		} 
