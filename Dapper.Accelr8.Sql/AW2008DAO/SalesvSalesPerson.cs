...
{
	public partial class SalesvSalesPerson : Dapper.Accelr8.Repo.Domain.BaseEntity<int>
	{
			public SalesvSalesPerson()
		{			
			IsDirty = false; 
			}
		...
		protected object _territoryName;
		public object TerritoryName 
		{ 
		...
		protected string _territoryGroup;
